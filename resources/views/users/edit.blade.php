        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('users.update')}}" method="POST" id="frmEdit">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input name="last_name" class="form-control" placeholder="Nombre..." value="{{ $user->last_name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input name="document" class="form-control" placeholder="Nombre..." value="{{ $user->document }}">
